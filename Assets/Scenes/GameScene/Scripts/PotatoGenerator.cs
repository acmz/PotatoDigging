...
public class PotatoGenerator : MonoBehaviour {
    ...
    private const float POTATO_GENERATE_INTERVAL = 0.1f;
    private float _potatoGenerateTime = 0.1f;
    ...
    public void GeneratePotato() {
        ...
        potatoObject.GetComponent<PotatoController>().PotatoShoot(potatoGeneratePos);
    }
